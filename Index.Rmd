...
Li, X., Wessels, K., Armston, J., Duncanson, L., Urbazaev, M., Naidoo, L., Mathieu, R., & Main, R. (2024). *Evaluation of GEDI footprint level biomass models in Southern African Savannas using airborne LiDAR and field measurements*. Science of Remote Sensing, 10, 100161. https://doi.org/10.1016/j.srs.2024.100161
...
eoPortal. (n.d.). *ISS: GEDI (Global Ecosystems Dynamics Investigation Lidar)*. https://www.eoportal.org/satellite-missions/iss-gedi

NASA Earthdata. (n.d.). *Global Ecosystem Dynamics Investigation*. https://www.earthdata.nasa.gov/data/projects/gedi
